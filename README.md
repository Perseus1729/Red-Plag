...
# Steps to run the code:
 ## Backend
 Clone the github repository using git clone https://github.com/Perseus1729/Red-Plag. 
 
 First Create a django-superuser.Go to the Directory containing manage.py("./codefrisk/"), 
